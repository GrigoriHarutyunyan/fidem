<div class="control-group cm-no-hide-input">
    <label class="control-label" for="elm_product_full_second_descr">{__("full_second_description")}:</label>
    <div class="controls">
        <div class="input-group {$input_append_wysiwyg_if_shared_product}">
            ...
            >{$product_data.full_second_description}</textarea>
            ...
            object_id="full_second_description"
            name="update_all_vendors[full_second_description]"
            component="products.full_second_description"
            hide_inputs=$hide_inputs_if_shared_product
            append=true
            }
        </div>
